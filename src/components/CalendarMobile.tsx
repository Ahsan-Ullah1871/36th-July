...
const CAT = {
	red: {
		...
		duo: "#7a1410",
		tag: "রক্তাক্ত",
		glow: "0 0 16px rgba(180,32,18,.34), ",
	},
	amber: {
		border: "#6b4e1e",
		accent: "#d8a63f",
	...
	green: {
		...
		duo: "#5a3e10",
		tag: "বিজয়",
		glow: "0 0 18px rgba(220,168,60,.22), ",
	},
} as const;
...
const MARTYRS =
	"আবু সাঈদ · মীর মাহফুজুর রহমান মুগ্ধ · ওয়াসিম আকরাম · ফারহান ফাইয়াজ · শেখ আশহাবুল ইয়ামিন · নাফিসা হোসেন মারওয়া · রুদ্র সেন · ইমাম হাসান তাঈম · সুমাইয়া আক্তার · রিয়া গোপ · দ্বীপ্ত দে · নাসিব হাসান রিয়ান · তাহমিদ তামিম · আনাস · মাহমুদুর রহমান সৈকত · ";
		...
		>
            ...
            radial-gradient(120% 40% at 50% 6%,rgba(96,22,12,.16),transparent 60%)`,
					...
					>
						...
						<h1
							style={{
								...
								margin: "12px 0 6px",
								textShadow:
									"0 2px 0 #000, 0 2px 14px rgba(0,0,0,.85)",
							}}
						>
							জুলাই
							<br />
						...
						<div
							style={{
								...
								background:
									"rgba(30,8,5,.5)",
								boxShadow: "0 0 24px rgba(120,20,12,.3)",
							}}
						>
							<div
								style={{
				...
				>
								...
								>
									...
									<div
										style={{
											...
											inset: 0,
											background:
												"linear-gradient(90deg,rgba(12,8,3,.97) 0%,rgba(12,8,3,.88) 48%,rgba(12,8,3,.55) 72%,rgba(12,8,3,.18) 100%)",
										}}
									/>
									<div
										style={{
										...
										>
											<div
												style={{
													...
													color: "#f6ead2",
													textShadow:
														"0 1px 6px rgba(0,0,0,.98), 0 0 2px rgba(0,0,0,.9)",
												}}
											>
												{
													d.date
					...
					>
						...
						<div
							style={{
								...
								inset: 0,
								background:
									"linear-gradient(0deg,rgba(0,0,0,.9) 0%,rgba(0,0,0,.6) 55%,rgba(0,0,0,.45) 100%), radial-gradient(75% 90% at 50% 116%,rgba(255,200,60,.16),transparent 68%)",
							}}
						/>
						<div
							style={{
						...
						>
							...
							<div
								style={{
									...
									color: "#ffd700",
									textShadow:
										"0 3px 0 #2a2000, 0 3px 14px rgba(0,0,0,.85)",
								}}
							>
								বিজয়
							</div>
					...
					>
						যেকোনো দিনে ট্যাপ করে সেই দিনের পূর্ণ
						বিবরণ দেখুন।
						<br />
